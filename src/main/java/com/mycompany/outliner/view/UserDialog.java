...
import com.mycompany.outliner.listener.UserDialogListener;
import com.mycompany.outliner.listener.UserFormDialogListener;
...
public final class UserDialog extends JDialog implements UserFormDialogListener{
    ...
    private void openAddEditDialog(User user) {
        ...
        userAddEditDialog.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
